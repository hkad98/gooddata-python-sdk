...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.DataSourceControllerApi(api_client)
    ...
    try:
        ...
        print("The response of DataSourceControllerApi->create_entity_data_sources:\n")
        pprint(api_response)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DataSourceControllerApi->get_all_entities_data_sources:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DataSourceControllerApi->get_entity_data_sources:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DataSourceControllerApi->patch_entity_data_sources:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DataSourceControllerApi->update_entity_data_sources:\n")
        pprint(api_response)
    except Exception as e:
