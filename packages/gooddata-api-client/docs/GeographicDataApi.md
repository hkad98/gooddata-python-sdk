...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.GeographicDataApi(api_client)
    ...
    try:
        ...
        print("The response of GeographicDataApi->create_entity_custom_geo_collections:\n")
        pprint(api_response)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GeographicDataApi->get_all_entities_custom_geo_collections:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GeographicDataApi->get_entity_custom_geo_collections:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GeographicDataApi->patch_entity_custom_geo_collections:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GeographicDataApi->update_entity_custom_geo_collections:\n")
        pprint(api_response)
    except Exception as e:
