...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ExportDefinitionsApi->search_entities_export_definitions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExportDefinitionsApi->search_entities_export_definitions: %s\n" % e)
```
