...
**has_secret_key** | **bool** | Flag indicating if webhook has a hmac secret key. | [optional] [readonly] 
**has_token** | **bool** | Flag indicating if webhook has a token. | [optional] [readonly] 
**secret_key** | **str** | Hmac secret key for the webhook signature. | [optional] 
