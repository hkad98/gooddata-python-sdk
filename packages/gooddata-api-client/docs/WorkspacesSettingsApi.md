...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WorkspacesSettingsApi->search_entities_custom_application_settings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkspacesSettingsApi->search_entities_custom_application_settings: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WorkspacesSettingsApi->search_entities_workspace_settings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkspacesSettingsApi->search_entities_workspace_settings: %s\n" % e)
```
