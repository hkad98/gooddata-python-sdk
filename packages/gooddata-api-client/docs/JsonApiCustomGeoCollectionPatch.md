...
json_api_custom_geo_collection_patch_instance = JsonApiCustomGeoCollectionPatch.from_json(json)
# print the JSON string representation of the object
print(JsonApiCustomGeoCollectionPatch.to_json())

# convert the object into a dict
json_api_custom_geo_collection_patch_dict = json_api_custom_geo_collection_patch_instance.to_dict()
# create an instance of JsonApiCustomGeoCollectionPatch from a dict
json_api_custom_geo_collection_patch_from_dict = JsonApiCustomGeoCollectionPatch.from_dict(json_api_custom_geo_collection_patch_dict)
```
