...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.FilterContextControllerApi(api_client)
    ...
    try:
        ...
        print("The response of FilterContextControllerApi->create_entity_filter_contexts:\n")
        pprint(api_response)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FilterContextControllerApi->get_all_entities_filter_contexts:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FilterContextControllerApi->get_entity_filter_contexts:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FilterContextControllerApi->patch_entity_filter_contexts:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FilterContextControllerApi->search_entities_filter_contexts:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FilterContextControllerApi->update_entity_filter_contexts:\n")
        pprint(api_response)
    except Exception as e:
