...
json_api_knowledge_recommendation_out_attributes_instance = JsonApiKnowledgeRecommendationOutAttributes.from_json(json)
# print the JSON string representation of the object
print(JsonApiKnowledgeRecommendationOutAttributes.to_json())

# convert the object into a dict
json_api_knowledge_recommendation_out_attributes_dict = json_api_knowledge_recommendation_out_attributes_instance.to_dict()
# create an instance of JsonApiKnowledgeRecommendationOutAttributes from a dict
json_api_knowledge_recommendation_out_attributes_from_dict = JsonApiKnowledgeRecommendationOutAttributes.from_dict(json_api_knowledge_recommendation_out_attributes_dict)
```
