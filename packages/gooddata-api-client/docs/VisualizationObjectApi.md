...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of VisualizationObjectApi->search_entities_visualization_objects:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VisualizationObjectApi->search_entities_visualization_objects: %s\n" % e)
```
