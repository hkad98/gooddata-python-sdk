...
aac_visualization_dependency_buckets_instance = AacVisualizationDependencyBuckets.from_json(json)
# print the JSON string representation of the object
print(AacVisualizationDependencyBuckets.to_json())

# convert the object into a dict
aac_visualization_dependency_buckets_dict = aac_visualization_dependency_buckets_instance.to_dict()
# create an instance of AacVisualizationDependencyBuckets from a dict
aac_visualization_dependency_buckets_from_dict = AacVisualizationDependencyBuckets.from_dict(aac_visualization_dependency_buckets_dict)
```
