...
[**delete_entity_organization_settings**](EntitiesApi.md#delete_entity_organization_settings) | **DELETE** /api/v1/entities/organizationSettings/{id} | Delete Organization Setting entity
...
[**get_all_entities_notification_channel_identifiers**](EntitiesApi.md#get_all_entities_notification_channel_identifiers) | **GET** /api/v1/entities/notificationChannelIdentifiers | Get all Notification Channel Identifier entities
...
[**get_all_entities_organization_settings**](EntitiesApi.md#get_all_entities_organization_settings) | **GET** /api/v1/entities/organizationSettings | Get Organization Setting entities
...
[**get_entity_entitlements**](EntitiesApi.md#get_entity_entitlements) | **GET** /api/v1/entities/entitlements/{id} | Get Entitlement entity
...
[**get_entity_notification_channel_identifiers**](EntitiesApi.md#get_entity_notification_channel_identifiers) | **GET** /api/v1/entities/notificationChannelIdentifiers/{id} | Get Notification Channel Identifier entity
...
[**get_entity_organization_settings**](EntitiesApi.md#get_entity_organization_settings) | **GET** /api/v1/entities/organizationSettings/{id} | Get Organization Setting entity
...
[**patch_entity_attributes**](EntitiesApi.md#patch_entity_attributes) | **PATCH** /api/v1/entities/workspaces/{workspaceId}/attributes/{objectId} | Patch an Attribute (beta)
...
[**patch_entity_facts**](EntitiesApi.md#patch_entity_facts) | **PATCH** /api/v1/entities/workspaces/{workspaceId}/facts/{objectId} | Patch a Fact (beta)
[**patch_entity_filter_contexts**](EntitiesApi.md#patch_entity_filter_contexts) | **PATCH** /api/v1/entities/workspaces/{workspaceId}/filterContexts/{objectId} | Patch a Filter Context
...
[**patch_entity_organization_settings**](EntitiesApi.md#patch_entity_organization_settings) | **PATCH** /api/v1/entities/organizationSettings/{id} | Patch Organization Setting entity
...
[**search_entities_aggregated_facts**](EntitiesApi.md#search_entities_aggregated_facts) | **POST** /api/v1/entities/workspaces/{workspaceId}/aggregatedFacts/search | The search endpoint (beta)
...
[**search_entities_automation_results**](EntitiesApi.md#search_entities_automation_results) | **POST** /api/v1/entities/workspaces/{workspaceId}/automationResults/search | The search endpoint (beta)
...
[**search_entities_memory_items**](EntitiesApi.md#search_entities_memory_items) | **POST** /api/v1/entities/workspaces/{workspaceId}/memoryItems/search | The search endpoint (beta)
...
[**update_entity_organization_settings**](EntitiesApi.md#update_entity_organization_settings) | **PUT** /api/v1/entities/organizationSettings/{id} | Put Organization Setting entity
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    include = ['createdBy,modifiedBy,certifiedBy,visualizationObjects,analyticalDashboards,labels,metrics,datasets,filterContexts,dashboardPlugins'] # List[str] | Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together. (optional)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->create_entity_custom_geo_collections:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->create_entity_custom_geo_collections: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->create_entity_knowledge_recommendations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->create_entity_knowledge_recommendations: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->create_entity_llm_providers:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->create_entity_memory_items:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->create_entity_memory_items: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    meta_include = ['metaInclude=permissions,config,hierarchy,dataModelDatasets,all'] # List[str] | Include Meta objects. (optional)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling EntitiesApi->delete_entity_knowledge_recommendations: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling EntitiesApi->delete_entity_memory_items: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->get_all_entities_custom_geo_collections:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->get_all_entities_custom_geo_collections: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->get_all_entities_knowledge_recommendations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->get_all_entities_knowledge_recommendations: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->get_all_entities_llm_providers:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->get_all_entities_memory_items:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->get_all_entities_memory_items: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    size = 20 # int | The size of the page to be returned (optional) (default to 20)
    sort = ['sort_example'] # List[str] | Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported. (optional)
    meta_include = ['metaInclude=permissions,config,hierarchy,dataModelDatasets,page,all'] # List[str] | Include Meta objects. (optional)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->get_entity_custom_geo_collections:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->get_entity_custom_geo_collections: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->get_entity_knowledge_recommendations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->get_entity_knowledge_recommendations: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->get_entity_llm_providers:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->get_entity_memory_items:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->get_entity_memory_items: %s\n" % e)
```
...
> JsonApiAttributeOutDocument patch_entity_attributes(workspace_id, object_id, json_api_attribute_patch_document, filter=filter, include=include)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    workspace_id = 'workspace_id_example' # str | 
    object_id = 'object_id_example' # str | 
    json_api_attribute_patch_document = gooddata_api_client.JsonApiAttributePatchDocument() # JsonApiAttributePatchDocument | 
    filter = 'title==someString;description==someString;dataset.id==321;defaultView.id==321' # str | Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123'). (optional)
    include = ['dataset,defaultView,labels,attributeHierarchies'] # List[str] | Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together. (optional)
    ...
    try:
        ...
        print("The response of EntitiesApi->patch_entity_attributes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->patch_entity_attributes: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->patch_entity_custom_geo_collections:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->patch_entity_custom_geo_collections: %s\n" % e)
```
...
> JsonApiDatasetOutDocument patch_entity_datasets(workspace_id, object_id, json_api_dataset_patch_document, filter=filter, include=include)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    workspace_id = 'workspace_id_example' # str | 
    object_id = 'object_id_example' # str | 
    json_api_dataset_patch_document = gooddata_api_client.JsonApiDatasetPatchDocument() # JsonApiDatasetPatchDocument | 
    filter = 'title==someString;description==someString' # str | Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123'). (optional)
    include = ['attributes,facts,aggregatedFacts,references,workspaceDataFilters'] # List[str] | Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together. (optional)
    ...
    try:
        ...
        print("The response of EntitiesApi->patch_entity_datasets:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->patch_entity_datasets: %s\n" % e)
```
...
# **patch_entity_facts**
> JsonApiFactOutDocument patch_entity_facts(workspace_id, object_id, json_api_fact_patch_document, filter=filter, include=include)
...
import gooddata_api_client
from gooddata_api_client.models.json_api_fact_out_document import JsonApiFactOutDocument
from gooddata_api_client.models.json_api_fact_patch_document import JsonApiFactPatchDocument
from gooddata_api_client.rest import ApiException
from pprint import pprint
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    workspace_id = 'workspace_id_example' # str | 
    object_id = 'object_id_example' # str | 
    json_api_fact_patch_document = gooddata_api_client.JsonApiFactPatchDocument() # JsonApiFactPatchDocument | 
    filter = 'title==someString;description==someString;dataset.id==321' # str | Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123'). (optional)
    include = ['dataset'] # List[str] | Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together. (optional)
    ...
    try:
        ...
        print("The response of EntitiesApi->patch_entity_facts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->patch_entity_facts: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->patch_entity_knowledge_recommendations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->patch_entity_knowledge_recommendations: %s\n" % e)
```
...
# **patch_entity_labels**
> JsonApiLabelOutDocument patch_entity_labels(workspace_id, object_id, json_api_label_patch_document, filter=filter, include=include)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    workspace_id = 'workspace_id_example' # str | 
    object_id = 'object_id_example' # str | 
    json_api_label_patch_document = gooddata_api_client.JsonApiLabelPatchDocument() # JsonApiLabelPatchDocument | 
    filter = 'title==someString;description==someString;attribute.id==321' # str | Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123'). (optional)
    include = ['attribute'] # List[str] | Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together. (optional)
    ...
    try:
        ...
        print("The response of EntitiesApi->patch_entity_labels:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->patch_entity_labels: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->patch_entity_llm_providers:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->patch_entity_memory_items:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->patch_entity_memory_items: %s\n" % e)
```
...
> JsonApiAggregatedFactOutList search_entities_aggregated_facts(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_aggregated_facts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_aggregated_facts: %s\n" % e)
```
...
> JsonApiAnalyticalDashboardOutList search_entities_analytical_dashboards(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_analytical_dashboards:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_analytical_dashboards: %s\n" % e)
```
...
> JsonApiAttributeHierarchyOutList search_entities_attribute_hierarchies(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_attribute_hierarchies:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_attribute_hierarchies: %s\n" % e)
```
...
> JsonApiAttributeOutList search_entities_attributes(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_attributes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_attributes: %s\n" % e)
```
...
> JsonApiAutomationResultOutList search_entities_automation_results(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_automation_results:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_automation_results: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_automations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_automations: %s\n" % e)
```
...
> JsonApiCustomApplicationSettingOutList search_entities_custom_application_settings(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_custom_application_settings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_custom_application_settings: %s\n" % e)
```
...
> JsonApiDashboardPluginOutList search_entities_dashboard_plugins(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_dashboard_plugins:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_dashboard_plugins: %s\n" % e)
```
...
> JsonApiDatasetOutList search_entities_datasets(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_datasets:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_datasets: %s\n" % e)
```
...
> JsonApiExportDefinitionOutList search_entities_export_definitions(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_export_definitions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_export_definitions: %s\n" % e)
```
...
> JsonApiFactOutList search_entities_facts(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_facts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_facts: %s\n" % e)
```
...
> JsonApiFilterContextOutList search_entities_filter_contexts(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_filter_contexts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_filter_contexts: %s\n" % e)
```
...
> JsonApiFilterViewOutList search_entities_filter_views(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_filter_views:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_filter_views: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_knowledge_recommendations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_knowledge_recommendations: %s\n" % e)
```
...
> JsonApiLabelOutList search_entities_labels(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_labels:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_labels: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_memory_items:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_memory_items: %s\n" % e)
```
...
> JsonApiMetricOutList search_entities_metrics(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_metrics:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_metrics: %s\n" % e)
```
...
> JsonApiUserDataFilterOutList search_entities_user_data_filters(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_user_data_filters:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_user_data_filters: %s\n" % e)
```
...
> JsonApiVisualizationObjectOutList search_entities_visualization_objects(workspace_id, entity_search_body, origin=origin, x_gdc_validate_relations=x_gdc_validate_relations)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_visualization_objects:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_visualization_objects: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_workspace_data_filter_settings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_workspace_data_filter_settings: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_workspace_data_filters:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_workspace_data_filters: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->search_entities_workspace_settings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->search_entities_workspace_settings: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->update_entity_custom_geo_collections:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->update_entity_custom_geo_collections: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->update_entity_knowledge_recommendations:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->update_entity_knowledge_recommendations: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->update_entity_llm_providers:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EntitiesApi->update_entity_memory_items:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EntitiesApi->update_entity_memory_items: %s\n" % e)
```
