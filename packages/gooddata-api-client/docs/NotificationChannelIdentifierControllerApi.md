...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.NotificationChannelIdentifierControllerApi(api_client)
    ...
    try:
        ...
        print("The response of NotificationChannelIdentifierControllerApi->get_all_entities_notification_channel_identifiers:\n")
        pprint(api_response)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NotificationChannelIdentifierControllerApi->get_entity_notification_channel_identifiers:\n")
        pprint(api_response)
    except Exception as e:
