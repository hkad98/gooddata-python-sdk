...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.FactsApi(api_client)
    ...
    try:
        ...
        print("The response of FactsApi->get_all_entities_aggregated_facts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FactsApi->get_all_entities_aggregated_facts: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FactsApi->get_all_entities_facts:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FactsApi->get_entity_aggregated_facts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FactsApi->get_entity_aggregated_facts: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FactsApi->get_entity_facts:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FactsApi->patch_entity_facts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FactsApi->patch_entity_facts: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FactsApi->search_entities_aggregated_facts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FactsApi->search_entities_aggregated_facts: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FactsApi->search_entities_facts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FactsApi->search_entities_facts: %s\n" % e)
```
