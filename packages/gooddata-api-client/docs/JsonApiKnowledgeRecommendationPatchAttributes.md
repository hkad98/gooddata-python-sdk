...
json_api_knowledge_recommendation_patch_attributes_instance = JsonApiKnowledgeRecommendationPatchAttributes.from_json(json)
# print the JSON string representation of the object
print(JsonApiKnowledgeRecommendationPatchAttributes.to_json())

# convert the object into a dict
json_api_knowledge_recommendation_patch_attributes_dict = json_api_knowledge_recommendation_patch_attributes_instance.to_dict()
# create an instance of JsonApiKnowledgeRecommendationPatchAttributes from a dict
json_api_knowledge_recommendation_patch_attributes_from_dict = JsonApiKnowledgeRecommendationPatchAttributes.from_dict(json_api_knowledge_recommendation_patch_attributes_dict)
```
