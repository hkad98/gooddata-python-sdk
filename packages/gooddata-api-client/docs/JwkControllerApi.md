...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.JwkControllerApi(api_client)
    ...
    try:
        ...
        print("The response of JwkControllerApi->create_entity_jwks:\n")
        pprint(api_response)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of JwkControllerApi->get_all_entities_jwks:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of JwkControllerApi->get_entity_jwks:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of JwkControllerApi->patch_entity_jwks:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of JwkControllerApi->update_entity_jwks:\n")
        pprint(api_response)
    except Exception as e:
