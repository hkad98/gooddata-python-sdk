...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.CookieSecurityConfigurationControllerApi(api_client)
    id = 'id_example' # str | 
    ...
    try:
        ...
        print("The response of CookieSecurityConfigurationControllerApi->get_entity_cookie_security_configurations:\n")
        pprint(api_response)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CookieSecurityConfigurationControllerApi->patch_entity_cookie_security_configurations:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CookieSecurityConfigurationControllerApi->update_entity_cookie_security_configurations:\n")
        pprint(api_response)
    except Exception as e:
