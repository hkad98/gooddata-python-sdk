...
**dashboard_tabs_filters_overrides** | **Dict[str, List[DashboardFilter]]** | Map of tab-specific filter overrides. Key is tabId, value is list of filters for that tab. | [optional] 
