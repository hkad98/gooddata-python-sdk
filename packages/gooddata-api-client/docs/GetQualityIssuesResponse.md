...
------------ | ------------- | ------------- | -------------
**issues** | [**List[QualityIssue]**](QualityIssue.md) | List of quality issues found in the workspace | 
**status** | **str** | Status of the latest triggered quality check process | 
**updated_at** | **str** | Timestamp when the quality issues were last updated (ISO format) | [optional] 
