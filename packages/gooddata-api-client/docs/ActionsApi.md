...
[**retrieve_result_binary**](ActionsApi.md#retrieve_result_binary) | **GET** /api/v1/actions/workspaces/{workspaceId}/execution/afm/execute/result/{resultId}/binary | (BETA) Get a single execution result in Apache Arrow File or Stream format
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->analyze_csv:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.ActionsApi(api_client)
    workspace_id = 'workspace_id_example' # str | Workspace identifier
    change_analysis_request = gooddata_api_client.ChangeAnalysisRequest() # ChangeAnalysisRequest | 

    try:
        # Compute change analysis
        api_response = api_instance.change_analysis(workspace_id, change_analysis_request)
        print("The response of ActionsApi->change_analysis:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->change_analysis_result:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->collect_cache_usage:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gooddata_api_client.ActionsApi(api_client)
    convert_geo_file_request = gooddata_api_client.ConvertGeoFileRequest() # ConvertGeoFileRequest | 

    try:
        # Convert a geo file to GeoParquet format
        api_response = api_instance.convert_geo_file(convert_geo_file_request)
        print("The response of ActionsApi->convert_geo_file:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->created_by:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gooddata_api_client.ActionsApi(api_client)
    file = None # bytes | The geo collection file to upload. Supported formats: GeoParquet (.parquet), GeoJSON (.geojson, .json), ESRI Shapefile (.zip).

    try:
        # Upload a geo collection file to the staging area
        api_response = api_instance.custom_geo_collection_staging_upload(file)
        print("The response of ActionsApi->custom_geo_collection_staging_upload:\n")
        pprint(api_response)
    except Exception as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **file** | **bytes**| The geo collection file to upload. Supported formats: GeoParquet (.parquet), GeoJSON (.geojson, .json), ESRI Shapefile (.zip). | 
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->generate_description:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->generate_logical_model_aac:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->generate_title:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_exported_file**
> bytes get_exported_file(workspace_id, export_id)
...
# **get_image_export**
> bytes get_image_export(workspace_id, export_id)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->get_quality_issues_calculation_status:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_raw_export**
> bytes get_raw_export(workspace_id, export_id)
...
# **get_slides_export**
> bytes get_slides_export(workspace_id, export_id)
...
# **get_tabular_export**
> bytes get_tabular_export(workspace_id, export_id)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->import_csv:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    import_geo_collection_request = gooddata_api_client.ImportGeoCollectionRequest() # ImportGeoCollectionRequest | 

    try:
        # Import custom geo collection
        api_response = api_instance.import_custom_geo_collection(collection_id, import_geo_collection_request)
        print("The response of ActionsApi->import_custom_geo_collection:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->list_files:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->list_llm_provider_models:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->list_llm_provider_models_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->memory_created_by_users:\n")
        pprint(api_response)
    except Exception as e:
...
# **outlier_detection**
> OutlierDetectionResponse outlier_detection(workspace_id, outlier_detection_request, skip_cache=skip_cache)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.ActionsApi(api_client)
    workspace_id = 'workspace_id_example' # str | Workspace identifier
    outlier_detection_request = gooddata_api_client.OutlierDetectionRequest() # OutlierDetectionRequest | 
    skip_cache = False # bool | Ignore all caches during execution of current request. (optional) (default to False)

    try:
        # (BETA) Outlier Detection
        api_response = api_instance.outlier_detection(workspace_id, outlier_detection_request, skip_cache=skip_cache)
        print("The response of ActionsApi->outlier_detection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActionsApi->outlier_detection: %s\n" % e)
```
...
> OutlierDetectionResult outlier_detection_result(workspace_id, result_id, offset=offset, limit=limit)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->outlier_detection_result:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActionsApi->outlier_detection_result: %s\n" % e)
```
...
> List[ReadCsvFileManifestsResponse] read_csv_file_manifests(data_source_id, read_csv_file_manifests_request)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.ActionsApi(api_client)
    data_source_id = 'data_source_id_example' # str | 
    read_csv_file_manifests_request = gooddata_api_client.ReadCsvFileManifestsRequest() # ReadCsvFileManifestsRequest | 

    try:
        # Read CSV file manifests
        api_response = api_instance.read_csv_file_manifests(data_source_id, read_csv_file_manifests_request)
        print("The response of ActionsApi->read_csv_file_manifests:\n")
        pprint(api_response)
    except Exception as e:
...
[**List[ReadCsvFileManifestsResponse]**](ReadCsvFileManifestsResponse.md)
...
> List[ResolvedSetting] resolve_all_settings_without_workspace(exclude_user_settings=exclude_user_settings)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gooddata_api_client.ActionsApi(api_client)
    exclude_user_settings = False # bool | If true, user-level settings are excluded from resolution. (optional) (default to False)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **exclude_user_settings** | **bool**| If true, user-level settings are excluded from resolution. | [optional] [default to False]
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->resolve_llm_providers:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActionsApi->resolve_llm_providers: %s\n" % e)
```
...
> List[ResolvedSetting] resolve_settings_without_workspace(resolve_settings_request, exclude_user_settings=exclude_user_settings)
...
> bytes retrieve_result_binary(workspace_id, result_id, x_gdc_cancel_token=x_gdc_cancel_token)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->retrieve_result_binary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActionsApi->retrieve_result_binary: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.ActionsApi(api_client)
    workspace_id = 'workspace_id_example' # str | 
    set_certification_request = gooddata_api_client.SetCertificationRequest() # SetCertificationRequest | 
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->staging_upload:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->test_llm_provider:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->test_llm_provider_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->trending_objects:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ActionsApi->trigger_quality_issues_calculation:\n")
        pprint(api_response)
    except Exception as e:
...
> List[ResolvedSetting] workspace_resolve_all_settings(workspace_id, exclude_user_settings=exclude_user_settings)
...
> List[ResolvedSetting] workspace_resolve_settings(workspace_id, resolve_settings_request, exclude_user_settings=exclude_user_settings)
