...
**measure_definition_overrides** | [**List[MetricDefinitionOverride]**](MetricDefinitionOverride.md) | (EXPERIMENTAL) Override definitions of catalog metrics for this request. Allows substituting a catalog metric&#39;s MAQL definition without modifying the stored definition. | [optional] 
