...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.WorkspacesEntityAPIsApi(api_client)
    ...
    try:
        ...
        print("The response of WorkspacesEntityAPIsApi->create_entity_workspaces:\n")
        pprint(api_response)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WorkspacesEntityAPIsApi->get_all_entities_workspaces:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WorkspacesEntityAPIsApi->get_entity_workspaces:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WorkspacesEntityAPIsApi->patch_entity_workspaces:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WorkspacesEntityAPIsApi->update_entity_workspaces:\n")
        pprint(api_response)
    except Exception as e:
