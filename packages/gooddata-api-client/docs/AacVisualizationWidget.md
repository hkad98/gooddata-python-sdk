...
**description** | [**AacVisualizationWidgetAllOfDescription**](AacVisualizationWidgetAllOfDescription.md) |  | [optional] 
...
**title** | [**AacVisualizationWidgetAllOfTitle**](AacVisualizationWidgetAllOfTitle.md) |  | [optional] 
...
aac_visualization_widget_instance = AacVisualizationWidget.from_json(json)
# print the JSON string representation of the object
print(AacVisualizationWidget.to_json())

# convert the object into a dict
aac_visualization_widget_dict = aac_visualization_widget_instance.to_dict()
# create an instance of AacVisualizationWidget from a dict
aac_visualization_widget_from_dict = AacVisualizationWidget.from_dict(aac_visualization_widget_dict)
```
