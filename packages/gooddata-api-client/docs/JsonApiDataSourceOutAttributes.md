...
------------ | ------------- | ------------- | -------------
**alternative_data_source_id** | **str** | Alternative data source ID. It is a weak reference meaning data source does not have to exist. All the entities (e.g. tables) from the data source must be available also in the alternative data source. It must be present in the same organization as the data source. | [optional] 
