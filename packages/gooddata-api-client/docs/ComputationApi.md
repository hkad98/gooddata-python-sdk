...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ComputationApi->cancel_executions:\n")
        pprint(api_response)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ComputationApi->change_analysis:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ComputationApi->change_analysis_result:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ComputationApi->outlier_detection:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ComputationApi->outlier_detection_result:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ComputationApi->retrieve_result_binary:\n")
        pprint(api_response)
    except Exception as e:
