...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LabelsApi->patch_entity_labels:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LabelsApi->patch_entity_labels: %s\n" % e)
```
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LabelsApi->search_entities_labels:\n")
        pprint(api_response)
    except Exception as e:
