...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.FilterViewControllerApi(api_client)
    ...
    try:
        ...
        print("The response of FilterViewControllerApi->create_entity_filter_views:\n")
        pprint(api_response)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FilterViewControllerApi->get_all_entities_filter_views:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FilterViewControllerApi->get_entity_filter_views:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FilterViewControllerApi->patch_entity_filter_views:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FilterViewControllerApi->search_entities_filter_views:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FilterViewControllerApi->update_entity_filter_views:\n")
        pprint(api_response)
    except Exception as e:
