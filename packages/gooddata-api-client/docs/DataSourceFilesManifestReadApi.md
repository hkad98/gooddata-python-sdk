...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.DataSourceFilesManifestReadApi(api_client)
    ...
    try:
        ...
        print("The response of DataSourceFilesManifestReadApi->read_csv_file_manifests:\n")
        pprint(api_response)
