...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.DataSourceIdentifierControllerApi(api_client)
    ...
    try:
        ...
        print("The response of DataSourceIdentifierControllerApi->get_all_entities_data_source_identifiers:\n")
        pprint(api_response)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DataSourceIdentifierControllerApi->get_entity_data_source_identifiers:\n")
        pprint(api_response)
    except Exception as e:
