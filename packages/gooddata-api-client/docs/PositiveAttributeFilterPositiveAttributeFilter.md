...
**uses_arbitrary_values** | **bool** | If true, indicates that the values in inElements were filled free-form, otherwise they have been picked from existing elements. | [optional] 
