...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.DashboardPluginControllerApi(api_client)
    ...
    try:
        ...
        print("The response of DashboardPluginControllerApi->create_entity_dashboard_plugins:\n")
        pprint(api_response)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DashboardPluginControllerApi->get_all_entities_dashboard_plugins:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DashboardPluginControllerApi->get_entity_dashboard_plugins:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DashboardPluginControllerApi->patch_entity_dashboard_plugins:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DashboardPluginControllerApi->search_entities_dashboard_plugins:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DashboardPluginControllerApi->update_entity_dashboard_plugins:\n")
        pprint(api_response)
    except Exception as e:
