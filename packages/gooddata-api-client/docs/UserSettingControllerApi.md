...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = gooddata_api_client.UserSettingControllerApi(api_client)
    ...
    try:
        ...
        print("The response of UserSettingControllerApi->create_entity_user_settings:\n")
        pprint(api_response)
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UserSettingControllerApi->get_all_entities_user_settings:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UserSettingControllerApi->get_entity_user_settings:\n")
        pprint(api_response)
    except Exception as e:
...
with gooddata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UserSettingControllerApi->update_entity_user_settings:\n")
        pprint(api_response)
    except Exception as e:
