...
**tabs** | [**List[AacTab]**](AacTab.md) | Dashboard tabs (for tabbed dashboards). | [optional] 
...
aac_dashboard_without_tabs_instance = AacDashboardWithoutTabs.from_json(json)
# print the JSON string representation of the object
print(AacDashboardWithoutTabs.to_json())

# convert the object into a dict
aac_dashboard_without_tabs_dict = aac_dashboard_without_tabs_instance.to_dict()
# create an instance of AacDashboardWithoutTabs from a dict
aac_dashboard_without_tabs_from_dict = AacDashboardWithoutTabs.from_dict(aac_dashboard_without_tabs_dict)
```
