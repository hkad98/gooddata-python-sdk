...
from gooddata_api_client.api_response import ApiResponse, T as ApiResponseT
import gooddata_api_client.models
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gooddata_api_client.models, klass)
