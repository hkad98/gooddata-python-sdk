...
class OptionsApi:
    ...
    def get_all_options(
        ...
        _param = self._get_all_options_serialize(
    ...
    @validate_call
    def get_all_options_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_all_options_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_all_options_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
