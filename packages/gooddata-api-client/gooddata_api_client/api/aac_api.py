...
class AacApi:
    ...
    def get_logical_model_aac(
        ...
        _param = self._get_logical_model_aac_serialize(
            workspace_id=workspace_id,
    ...
    @validate_call
    def get_logical_model_aac_with_http_info(
        self,
        workspace_id: StrictStr,
        include_parents: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_logical_model_aac_without_preload_content(
        self,
        workspace_id: StrictStr,
        include_parents: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _get_logical_model_aac_serialize(
        self,
        workspace_id,
        include_parents,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/aac/workspaces/{workspaceId}/logicalModel',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def set_logical_model_aac(
        ...
        :param workspace_id: (required)
        :type workspace_id: str
        :param aac_logical_model: (required)
        :type aac_logical_model: AacLogicalModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._set_logical_model_aac_serialize(
            workspace_id=workspace_id,
            aac_logical_model=aac_logical_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def set_logical_model_aac_with_http_info(
        self,
        workspace_id: StrictStr,
        aac_logical_model: AacLogicalModel,
        _request_timeout: Union[
    ...
    @validate_call
    def set_logical_model_aac_without_preload_content(
        self,
        workspace_id: StrictStr,
        aac_logical_model: AacLogicalModel,
        _request_timeout: Union[
    ...
    def _set_logical_model_aac_serialize(
        self,
        workspace_id,
        aac_logical_model,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if aac_logical_model is not None:
            _body_params = aac_logical_model
