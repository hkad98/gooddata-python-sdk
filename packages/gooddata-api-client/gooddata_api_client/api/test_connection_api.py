...
class TestConnectionApi:
    ...
    def test_data_source(
        ...
        _param = self._test_data_source_serialize(
    ...
    @validate_call
    def test_data_source_with_http_info(
        self,
        data_source_id: Annotated[str, Field(strict=True, description="Data source id")],
        test_request: TestRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def test_data_source_without_preload_content(
        self,
        data_source_id: Annotated[str, Field(strict=True, description="Data source id")],
        test_request: TestRequest,
        _request_timeout: Union[
    ...
    def _test_data_source_serialize(
        self,
        data_source_id,
        test_request,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/dataSources/{dataSourceId}/test',
    ...
    def test_data_source_definition(
        ...
        :param test_definition_request: (required)
        :type test_definition_request: TestDefinitionRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._test_data_source_definition_serialize(
            test_definition_request=test_definition_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def test_data_source_definition_with_http_info(
        self,
        test_definition_request: TestDefinitionRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def test_data_source_definition_without_preload_content(
        self,
        test_definition_request: TestDefinitionRequest,
        _request_timeout: Union[
            None,
    ...
    def _test_data_source_definition_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if test_definition_request is not None:
            _body_params = test_definition_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/dataSource/test',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
