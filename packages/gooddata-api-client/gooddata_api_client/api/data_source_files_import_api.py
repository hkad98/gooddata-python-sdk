...
class DataSourceFilesImportApi:
    ...
    def import_csv(
        ...
        :param import_csv_request: (required)
        :type import_csv_request: ImportCsvRequest
        ...
        _param = self._import_csv_serialize(
            ...
            import_csv_request=import_csv_request,
    ...
    def import_csv_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ImportCsvResponse]]:
        """Import CSV
    ...
    def _import_csv_serialize(
        ...
        if import_csv_request is not None:
            _body_params = import_csv_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/fileStorage/dataSources/{dataSourceId}/importCsv',
