...
class UsageApi:
    ...
    def all_platform_usage(
        ...
        _param = self._all_platform_usage_serialize(
    ...
    @validate_call
    def all_platform_usage_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[PlatformUsage]]:
        """Info about the platform usage.
    ...
    @validate_call
    def all_platform_usage_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _all_platform_usage_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/actions/collectUsage',
    ...
    def particular_platform_usage(
        ...
        :param platform_usage_request: (required)
        :type platform_usage_request: PlatformUsageRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._particular_platform_usage_serialize(
            platform_usage_request=platform_usage_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def particular_platform_usage_with_http_info(
        self,
        platform_usage_request: PlatformUsageRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def particular_platform_usage_without_preload_content(
        self,
        platform_usage_request: PlatformUsageRequest,
        _request_timeout: Union[
            None,
    ...
    def _particular_platform_usage_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if platform_usage_request is not None:
            _body_params = platform_usage_request
