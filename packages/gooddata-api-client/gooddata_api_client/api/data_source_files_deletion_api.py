...
class DataSourceFilesDeletionApi:
    ...
    def delete_files(
        ...
        :param delete_files_request: (required)
        :type delete_files_request: DeleteFilesRequest
    ...
    def _delete_files_serialize(
        ...
        if delete_files_request is not None:
            _body_params = delete_files_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/fileStorage/dataSources/{dataSourceId}/deleteFiles',
