...
class DataSourceFilesManifestReadApi:
    ...
    def read_csv_file_manifests(
    ...
    ) -> List[ReadCsvFileManifestsResponse]:
        ...
        :param read_csv_file_manifests_request: (required)
        :type read_csv_file_manifests_request: ReadCsvFileManifestsRequest
        ...
        _param = self._read_csv_file_manifests_serialize(
            data_source_id=data_source_id,
            read_csv_file_manifests_request=read_csv_file_manifests_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ReadCsvFileManifestsResponse]",
        }
    ...
    @validate_call
    def read_csv_file_manifests_with_http_info(
        self,
        data_source_id: StrictStr,
        read_csv_file_manifests_request: ReadCsvFileManifestsRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ReadCsvFileManifestsResponse]]:
        """Read CSV file manifests
    ...
    @validate_call
    def read_csv_file_manifests_without_preload_content(
        self,
        data_source_id: StrictStr,
        read_csv_file_manifests_request: ReadCsvFileManifestsRequest,
        _request_timeout: Union[
    ...
    def _read_csv_file_manifests_serialize(
        self,
        data_source_id,
        ...
        if read_csv_file_manifests_request is not None:
            _body_params = read_csv_file_manifests_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/fileStorage/dataSources/{dataSourceId}/readCsvFileManifests',
