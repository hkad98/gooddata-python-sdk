...
class CacheUsageApi:
    ...
    def collect_cache_usage(
        ...
        _param = self._collect_cache_usage_serialize(
    ...
    @validate_call
    def collect_cache_usage_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def collect_cache_usage_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _collect_cache_usage_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/actions/collectCacheUsage',
