...
class UserIdentifierControllerApi:
    ...
    def get_all_entities_user_identifiers(
        ...
        _param = self._get_all_entities_user_identifiers_serialize(
            filter=filter,
            page=page,
            size=size,
            sort=sort,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "JsonApiUserIdentifierOutList",
        }
    ...
    @validate_call
    def get_all_entities_user_identifiers_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[StrictInt], Field(description="The size of the page to be returned")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonApiUserIdentifierOutList]:
        """Get UserIdentifier entities
    ...
    @validate_call
    def get_all_entities_user_identifiers_without_preload_content(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[StrictInt], Field(description="The size of the page to be returned")] = None,
    ...
    def _get_all_entities_user_identifiers_serialize(
        self,
        filter,
        page,
        size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/entities/userIdentifiers',
    ...
    def get_entity_user_identifiers(
        ...
        _param = self._get_entity_user_identifiers_serialize(
            id=id,
            filter=filter,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "JsonApiUserIdentifierOutDocument",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_entity_user_identifiers_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonApiUserIdentifierOutDocument]:
        """Get UserIdentifier entity
    ...
    @validate_call
    def get_entity_user_identifiers_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        _request_timeout: Union[
    ...
    def _get_entity_user_identifiers_serialize(
        self,
        id,
        filter,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/entities/userIdentifiers/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
