...
class JwkControllerApi:
    ...
    def create_entity_jwks(
        ...
        :param json_api_jwk_in_document: (required)
        :type json_api_jwk_in_document: JsonApiJwkInDocument
        ...
        _param = self._create_entity_jwks_serialize(
    ...
    @validate_call
    def create_entity_jwks_with_http_info(
        self,
        json_api_jwk_in_document: JsonApiJwkInDocument,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonApiJwkOutDocument]:
        """Post Jwks
    ...
    @validate_call
    def create_entity_jwks_without_preload_content(
        self,
        json_api_jwk_in_document: JsonApiJwkInDocument,
        _request_timeout: Union[
            None,
    ...
    def _create_entity_jwks_serialize(
        self,
        ...
        if json_api_jwk_in_document is not None:
            _body_params = json_api_jwk_in_document
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/entities/jwks',
    ...
    def delete_entity_jwks(
        ...
        _param = self._delete_entity_jwks_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_entity_jwks_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_entity_jwks_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _delete_entity_jwks_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/entities/jwks/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_entities_jwks(
        ...
        _param = self._get_all_entities_jwks_serialize(
            filter=filter,
            page=page,
            size=size,
            sort=sort,
    ...
    @validate_call
    def get_all_entities_jwks_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[StrictInt], Field(description="The size of the page to be returned")] = None,
    ...
    @validate_call
    def get_all_entities_jwks_without_preload_content(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[StrictInt], Field(description="The size of the page to be returned")] = None,
    ...
    def _get_all_entities_jwks_serialize(
        self,
        filter,
        page,
        size,
    ...
    def get_entity_jwks(
        ...
        _param = self._get_entity_jwks_serialize(
            id=id,
            filter=filter,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_entity_jwks_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_entity_jwks_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        _request_timeout: Union[
    ...
    def _get_entity_jwks_serialize(
        self,
        id,
        filter,
        _request_auth,
    ...
    def patch_entity_jwks(
        ...
        :param id: (required)
        :type id: str
        :param json_api_jwk_patch_document: (required)
        :type json_api_jwk_patch_document: JsonApiJwkPatchDocument
        :param filter: Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').
        :type filter: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._patch_entity_jwks_serialize(
            id=id,
            json_api_jwk_patch_document=json_api_jwk_patch_document,
            filter=filter,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def patch_entity_jwks_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        json_api_jwk_patch_document: JsonApiJwkPatchDocument,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
    ...
    @validate_call
    def patch_entity_jwks_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        json_api_jwk_patch_document: JsonApiJwkPatchDocument,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
    ...
    def _patch_entity_jwks_serialize(
        self,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if json_api_jwk_patch_document is not None:
            _body_params = json_api_jwk_patch_document
    ...
    def update_entity_jwks(
        ...
        _param = self._update_entity_jwks_serialize(
            id=id,
            json_api_jwk_in_document=json_api_jwk_in_document,
            filter=filter,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_entity_jwks_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        json_api_jwk_in_document: JsonApiJwkInDocument,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
    ...
    @validate_call
    def update_entity_jwks_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        json_api_jwk_in_document: JsonApiJwkInDocument,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
    ...
    def _update_entity_jwks_serialize(
        self,
        id,
        json_api_jwk_in_document,
        filter,
