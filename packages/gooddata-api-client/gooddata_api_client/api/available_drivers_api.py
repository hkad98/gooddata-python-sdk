...
class AvailableDriversApi:
    ...
    def get_data_source_drivers(
        ...
        _param = self._get_data_source_drivers_serialize(
    ...
    @validate_call
    def get_data_source_drivers_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_data_source_drivers_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_data_source_drivers_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/options/availableDrivers',
