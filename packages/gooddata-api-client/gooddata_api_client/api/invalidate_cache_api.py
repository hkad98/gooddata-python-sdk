...
class InvalidateCacheApi:
    ...
    def register_upload_notification(
        ...
        _param = self._register_upload_notification_serialize(
    ...
    @validate_call
    def register_upload_notification_with_http_info(
        self,
        data_source_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def register_upload_notification_without_preload_content(
        self,
        data_source_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _register_upload_notification_serialize(
        self,
        data_source_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/dataSources/{dataSourceId}/uploadNotification',
