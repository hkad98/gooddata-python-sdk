...
class EntitlementApi:
    ...
    def get_all_entities_entitlements(
        ...
        _param = self._get_all_entities_entitlements_serialize(
            filter=filter,
            page=page,
            size=size,
            sort=sort,
    ...
    @validate_call
    def get_all_entities_entitlements_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[StrictInt], Field(description="The size of the page to be returned")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonApiEntitlementOutList]:
        """Get Entitlements
    ...
    @validate_call
    def get_all_entities_entitlements_without_preload_content(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[StrictInt], Field(description="The size of the page to be returned")] = None,
    ...
    def _get_all_entities_entitlements_serialize(
        self,
        filter,
        page,
        size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/entities/entitlements',
    ...
    def get_entity_entitlements(
        ...
        _param = self._get_entity_entitlements_serialize(
            id=id,
            filter=filter,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "JsonApiEntitlementOutDocument",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_entity_entitlements_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonApiEntitlementOutDocument]:
        """Get Entitlement entity
    ...
    @validate_call
    def get_entity_entitlements_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        _request_timeout: Union[
    ...
    def _get_entity_entitlements_serialize(
        self,
        id,
        filter,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/entities/entitlements/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def resolve_all_entitlements(
        ...
        _param = self._resolve_all_entitlements_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def resolve_all_entitlements_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ApiEntitlement]]:
        """Values for all public entitlements.
    ...
    @validate_call
    def resolve_all_entitlements_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _resolve_all_entitlements_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/actions/resolveEntitlements',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def resolve_requested_entitlements(
        ...
        :param entitlements_request: (required)
        :type entitlements_request: EntitlementsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._resolve_requested_entitlements_serialize(
    ...
    @validate_call
    def resolve_requested_entitlements_with_http_info(
        self,
        entitlements_request: EntitlementsRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def resolve_requested_entitlements_without_preload_content(
        self,
        entitlements_request: EntitlementsRequest,
        _request_timeout: Union[
            None,
    ...
    def _resolve_requested_entitlements_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if entitlements_request is not None:
            _body_params = entitlements_request
