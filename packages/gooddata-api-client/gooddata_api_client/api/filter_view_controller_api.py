...
class FilterViewControllerApi:
    ...
    def search_entities_filter_views(
        ...
        _param = self._search_entities_filter_views_serialize(
            workspace_id=workspace_id,
    ...
    @validate_call
    def search_entities_filter_views_with_http_info(
        self,
        workspace_id: StrictStr,
        entity_search_body: Annotated[EntitySearchBody, Field(description="Search request body with filter, pagination, and sorting options")],
        origin: Optional[StrictStr] = None,
    ...
    @validate_call
    def search_entities_filter_views_without_preload_content(
        self,
        workspace_id: StrictStr,
        entity_search_body: Annotated[EntitySearchBody, Field(description="Search request body with filter, pagination, and sorting options")],
        origin: Optional[StrictStr] = None,
    ...
    def _search_entities_filter_views_serialize(
        self,
        workspace_id,
        entity_search_body,
        origin,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/entities/workspaces/{workspaceId}/filterViews/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
