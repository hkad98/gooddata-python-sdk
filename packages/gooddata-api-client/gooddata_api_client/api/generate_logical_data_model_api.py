...
class GenerateLogicalDataModelApi:
    ...
    def generate_logical_model(
        ...
        :param generate_ldm_request: (required)
        :type generate_ldm_request: GenerateLdmRequest
        ...
        _param = self._generate_logical_model_serialize(
    ...
    @validate_call
    def generate_logical_model_with_http_info(
        self,
        data_source_id: StrictStr,
        generate_ldm_request: GenerateLdmRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def generate_logical_model_without_preload_content(
        self,
        data_source_id: StrictStr,
        generate_ldm_request: GenerateLdmRequest,
        _request_timeout: Union[
    ...
    def _generate_logical_model_serialize(
        self,
        data_source_id,
        ...
        if generate_ldm_request is not None:
            _body_params = generate_ldm_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/dataSources/{dataSourceId}/generateLogicalModel',
    ...
    def generate_logical_model_aac(
        ...
        _param = self._generate_logical_model_aac_serialize(
            data_source_id=data_source_id,
            generate_ldm_request=generate_ldm_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def generate_logical_model_aac_with_http_info(
        self,
        data_source_id: StrictStr,
        generate_ldm_request: GenerateLdmRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def generate_logical_model_aac_without_preload_content(
        self,
        data_source_id: StrictStr,
        generate_ldm_request: GenerateLdmRequest,
        _request_timeout: Union[
    ...
    def _generate_logical_model_aac_serialize(
        self,
        data_source_id,
        generate_ldm_request,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/dataSources/{dataSourceId}/generateLogicalModelAac',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
