...
class DatasetsApi:
    ...
    def patch_entity_datasets(
        ...
        :param object_id: (required)
        :type object_id: str
        :param json_api_dataset_patch_document: (required)
        :type json_api_dataset_patch_document: JsonApiDatasetPatchDocument
        :param filter: Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').
        :type filter: str
        :param include: Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together.
        :type include: List[str]
        ...
        _param = self._patch_entity_datasets_serialize(
            workspace_id=workspace_id,
            object_id=object_id,
            json_api_dataset_patch_document=json_api_dataset_patch_document,
            filter=filter,
            include=include,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_entity_datasets_with_http_info(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        json_api_dataset_patch_document: JsonApiDatasetPatchDocument,
    ...
    @validate_call
    def patch_entity_datasets_without_preload_content(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        json_api_dataset_patch_document: JsonApiDatasetPatchDocument,
    ...
    def _patch_entity_datasets_serialize(
        self,
        workspace_id,
        object_id,
        ...
        # process the form parameters
        # process the body parameter
        if json_api_dataset_patch_document is not None:
            _body_params = json_api_dataset_patch_document
    ...
    def search_entities_datasets(
        ...
        _param = self._search_entities_datasets_serialize(
            workspace_id=workspace_id,
    ...
    @validate_call
    def search_entities_datasets_with_http_info(
        self,
        workspace_id: StrictStr,
        entity_search_body: Annotated[EntitySearchBody, Field(description="Search request body with filter, pagination, and sorting options")],
        origin: Optional[StrictStr] = None,
    ...
    @validate_call
    def search_entities_datasets_without_preload_content(
        self,
        workspace_id: StrictStr,
        entity_search_body: Annotated[EntitySearchBody, Field(description="Search request body with filter, pagination, and sorting options")],
        origin: Optional[StrictStr] = None,
    ...
    def _search_entities_datasets_serialize(
        self,
        workspace_id,
        entity_search_body,
        origin,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/entities/workspaces/{workspaceId}/datasets/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
