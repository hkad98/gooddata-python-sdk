...
class ComputationApi:
    ...
    def cancel_executions(
        ...
        :param afm_cancel_tokens: (required)
        :type afm_cancel_tokens: AfmCancelTokens
        ...
        _param = self._cancel_executions_serialize(
            workspace_id=workspace_id,
            afm_cancel_tokens=afm_cancel_tokens,
    ...
    @validate_call
    def cancel_executions_with_http_info(
        self,
        workspace_id: Annotated[str, Field(strict=True, description="Workspace identifier")],
        afm_cancel_tokens: AfmCancelTokens,
        _request_timeout: Union[
    ...
    @validate_call
    def cancel_executions_without_preload_content(
        self,
        workspace_id: Annotated[str, Field(strict=True, description="Workspace identifier")],
        afm_cancel_tokens: AfmCancelTokens,
        _request_timeout: Union[
    ...
    def _cancel_executions_serialize(
        self,
        workspace_id,
        afm_cancel_tokens,
        _request_auth,
        ...
        if afm_cancel_tokens is not None:
            _body_params = afm_cancel_tokens
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/workspaces/{workspaceId}/execution/afm/cancel',
    ...
    def change_analysis(
        ...
        :param workspace_id: Workspace identifier (required)
        :type workspace_id: str
        :param change_analysis_request: (required)
        :type change_analysis_request: ChangeAnalysisRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._change_analysis_serialize(
            workspace_id=workspace_id,
            change_analysis_request=change_analysis_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def change_analysis_with_http_info(
        self,
        workspace_id: Annotated[str, Field(strict=True, description="Workspace identifier")],
        change_analysis_request: ChangeAnalysisRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ChangeAnalysisResponse]:
        """Compute change analysis
    ...
    @validate_call
    def change_analysis_without_preload_content(
        self,
        workspace_id: Annotated[str, Field(strict=True, description="Workspace identifier")],
        change_analysis_request: ChangeAnalysisRequest,
        _request_timeout: Union[
    ...
    def _change_analysis_serialize(
        self,
        workspace_id,
        change_analysis_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if change_analysis_request is not None:
            _body_params = change_analysis_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/workspaces/{workspaceId}/execution/computeChangeAnalysis',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def change_analysis_result(
        ...
        _param = self._change_analysis_result_serialize(
            workspace_id=workspace_id,
            result_id=result_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def change_analysis_result_with_http_info(
        self,
        workspace_id: Annotated[str, Field(strict=True, description="Workspace identifier")],
        result_id: Annotated[StrictStr, Field(description="Result ID")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ChangeAnalysisResult]:
        """Get change analysis result
    ...
    @validate_call
    def change_analysis_result_without_preload_content(
        self,
        workspace_id: Annotated[str, Field(strict=True, description="Workspace identifier")],
        result_id: Annotated[StrictStr, Field(description="Result ID")],
        _request_timeout: Union[
    ...
    def _change_analysis_result_serialize(
        self,
        workspace_id,
        result_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/actions/workspaces/{workspaceId}/execution/computeChangeAnalysis/result/{resultId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def outlier_detection(
        ...
        :param workspace_id: Workspace identifier (required)
        :type workspace_id: str
        :param outlier_detection_request: (required)
        :type outlier_detection_request: OutlierDetectionRequest
        :param skip_cache: Ignore all caches during execution of current request.
        :type skip_cache: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._outlier_detection_serialize(
            workspace_id=workspace_id,
            outlier_detection_request=outlier_detection_request,
            skip_cache=skip_cache,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def outlier_detection_with_http_info(
        self,
        workspace_id: Annotated[str, Field(strict=True, description="Workspace identifier")],
        outlier_detection_request: OutlierDetectionRequest,
        skip_cache: Annotated[Optional[StrictBool], Field(description="Ignore all caches during execution of current request.")] = None,
    ...
    @validate_call
    def outlier_detection_without_preload_content(
        self,
        workspace_id: Annotated[str, Field(strict=True, description="Workspace identifier")],
        outlier_detection_request: OutlierDetectionRequest,
        skip_cache: Annotated[Optional[StrictBool], Field(description="Ignore all caches during execution of current request.")] = None,
    ...
    def _outlier_detection_serialize(
        self,
        workspace_id,
        ...
        # process the form parameters
        # process the body parameter
        if outlier_detection_request is not None:
            _body_params = outlier_detection_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/workspaces/{workspaceId}/execution/detectOutliers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def outlier_detection_result(
        ...
        _param = self._outlier_detection_result_serialize(
            workspace_id=workspace_id,
            result_id=result_id,
            offset=offset,
            limit=limit,
    ...
    @validate_call
    def outlier_detection_result_with_http_info(
        self,
        workspace_id: Annotated[str, Field(strict=True, description="Workspace identifier")],
        result_id: Annotated[StrictStr, Field(description="Result ID")],
        offset: Optional[StrictInt] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OutlierDetectionResult]:
        """(BETA) Outlier Detection Result
    ...
    @validate_call
    def outlier_detection_result_without_preload_content(
        self,
        workspace_id: Annotated[str, Field(strict=True, description="Workspace identifier")],
        result_id: Annotated[StrictStr, Field(description="Result ID")],
        offset: Optional[StrictInt] = None,
    ...
    def _outlier_detection_result_serialize(
        self,
        workspace_id,
        result_id,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/actions/workspaces/{workspaceId}/execution/detectOutliers/result/{resultId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def retrieve_result_binary(
        ...
        _param = self._retrieve_result_binary_serialize(
            workspace_id=workspace_id,
            result_id=result_id,
            x_gdc_cancel_token=x_gdc_cancel_token,
            _request_auth=_request_auth,
    ...
    @validate_call
    def retrieve_result_binary_with_http_info(
        self,
        workspace_id: Annotated[str, Field(strict=True, description="Workspace identifier")],
        result_id: Annotated[StrictStr, Field(description="Result ID")],
        x_gdc_cancel_token: Optional[StrictStr] = None,
    ...
    @validate_call
    def retrieve_result_binary_without_preload_content(
        self,
        workspace_id: Annotated[str, Field(strict=True, description="Workspace identifier")],
        result_id: Annotated[StrictStr, Field(description="Result ID")],
        x_gdc_cancel_token: Optional[StrictStr] = None,
    ...
    def _retrieve_result_binary_serialize(
        self,
        workspace_id,
        result_id,
        x_gdc_cancel_token,
