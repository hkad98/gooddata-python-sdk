...
class UserGroupControllerApi:
    ...
    def create_entity_user_groups(
        ...
        :param json_api_user_group_in_document: (required)
        :type json_api_user_group_in_document: JsonApiUserGroupInDocument
        ...
        _param = self._create_entity_user_groups_serialize(
            json_api_user_group_in_document=json_api_user_group_in_document,
            include=include,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "JsonApiUserGroupOutDocument",
        }
    ...
    @validate_call
    def create_entity_user_groups_with_http_info(
        self,
        json_api_user_group_in_document: JsonApiUserGroupInDocument,
        include: Annotated[Optional[List[StrictStr]], Field(description="Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonApiUserGroupOutDocument]:
        """Post User Group entities
    ...
    @validate_call
    def create_entity_user_groups_without_preload_content(
        self,
        json_api_user_group_in_document: JsonApiUserGroupInDocument,
        include: Annotated[Optional[List[StrictStr]], Field(description="Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together.")] = None,
        _request_timeout: Union[
    ...
    def _create_entity_user_groups_serialize(
        self,
        ...
        if json_api_user_group_in_document is not None:
            _body_params = json_api_user_group_in_document
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/entities/userGroups',
    ...
    def delete_entity_user_groups(
        ...
        _param = self._delete_entity_user_groups_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_entity_user_groups_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_entity_user_groups_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _delete_entity_user_groups_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/entities/userGroups/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_entities_user_groups(
        ...
        _param = self._get_all_entities_user_groups_serialize(
            filter=filter,
            include=include,
            page=page,
            size=size,
    ...
    @validate_call
    def get_all_entities_user_groups_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Zero-based page index (0..N)")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonApiUserGroupOutList]:
        """Get UserGroup entities
    ...
    @validate_call
    def get_all_entities_user_groups_without_preload_content(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Zero-based page index (0..N)")] = None,
    ...
    def _get_all_entities_user_groups_serialize(
        self,
        filter,
        include,
        page,
    ...
    def get_entity_user_groups(
        ...
        _param = self._get_entity_user_groups_serialize(
            id=id,
            filter=filter,
            include=include,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "JsonApiUserGroupOutDocument",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_entity_user_groups_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together.")] = None,
    ...
    @validate_call
    def get_entity_user_groups_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together.")] = None,
    ...
    def _get_entity_user_groups_serialize(
        self,
        id,
        filter,
        include,
    ...
    def patch_entity_user_groups(
        ...
        :param id: (required)
        :type id: str
        :param json_api_user_group_patch_document: (required)
        :type json_api_user_group_patch_document: JsonApiUserGroupPatchDocument
        :param filter: Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').
        :type filter: str
        :param include: Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together.
        :type include: List[str]
        ...
        _param = self._patch_entity_user_groups_serialize(
            id=id,
            json_api_user_group_patch_document=json_api_user_group_patch_document,
            filter=filter,
            include=include,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_entity_user_groups_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        json_api_user_group_patch_document: JsonApiUserGroupPatchDocument,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
    ...
    @validate_call
    def patch_entity_user_groups_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        json_api_user_group_patch_document: JsonApiUserGroupPatchDocument,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
    ...
    def _patch_entity_user_groups_serialize(
        self,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if json_api_user_group_patch_document is not None:
            _body_params = json_api_user_group_patch_document
    ...
    def update_entity_user_groups(
        ...
        _param = self._update_entity_user_groups_serialize(
            id=id,
            json_api_user_group_in_document=json_api_user_group_in_document,
            filter=filter,
            include=include,
    ...
    @validate_call
    def update_entity_user_groups_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        json_api_user_group_in_document: JsonApiUserGroupInDocument,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
    ...
    @validate_call
    def update_entity_user_groups_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        json_api_user_group_in_document: JsonApiUserGroupInDocument,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
    ...
    def _update_entity_user_groups_serialize(
        self,
        id,
        json_api_user_group_in_document,
        filter,
