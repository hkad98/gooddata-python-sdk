...
class ImageExportApi:
    ...
    def create_image_export(
        ...
        :param image_export_request: (required)
        :type image_export_request: ImageExportRequest
        ...
        _param = self._create_image_export_serialize(
            ...
            image_export_request=image_export_request,
    ...
    def _create_image_export_serialize(
        ...
        if image_export_request is not None:
            _body_params = image_export_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/workspaces/{workspaceId}/export/image',
    ...
    def _get_image_export_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/actions/workspaces/{workspaceId}/export/image/{exportId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_image_export_metadata(
        ...
        _param = self._get_image_export_metadata_serialize(
            workspace_id=workspace_id,
            export_id=export_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_image_export_metadata_with_http_info(
        self,
        workspace_id: StrictStr,
        export_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def get_image_export_metadata_without_preload_content(
        self,
        workspace_id: StrictStr,
        export_id: StrictStr,
        _request_timeout: Union[
    ...
    def _get_image_export_metadata_serialize(
        self,
        workspace_id,
        export_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/actions/workspaces/{workspaceId}/export/image/{exportId}/metadata',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
