...
class ExportDefinitionControllerApi:
    ...
    def create_entity_export_definitions(
        ...
        :param json_api_export_definition_post_optional_id_document: (required)
        :type json_api_export_definition_post_optional_id_document: JsonApiExportDefinitionPostOptionalIdDocument
        ...
        _param = self._create_entity_export_definitions_serialize(
            workspace_id=workspace_id,
            json_api_export_definition_post_optional_id_document=json_api_export_definition_post_optional_id_document,
            include=include,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "JsonApiExportDefinitionOutDocument",
        }
    ...
    @validate_call
    def create_entity_export_definitions_with_http_info(
        self,
        workspace_id: StrictStr,
        json_api_export_definition_post_optional_id_document: JsonApiExportDefinitionPostOptionalIdDocument,
        include: Annotated[Optional[List[StrictStr]], Field(description="Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonApiExportDefinitionOutDocument]:
        """Post Export Definitions
    ...
    @validate_call
    def create_entity_export_definitions_without_preload_content(
        self,
        workspace_id: StrictStr,
        json_api_export_definition_post_optional_id_document: JsonApiExportDefinitionPostOptionalIdDocument,
        include: Annotated[Optional[List[StrictStr]], Field(description="Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together.")] = None,
    ...
    def _create_entity_export_definitions_serialize(
        self,
        workspace_id,
        ...
        if json_api_export_definition_post_optional_id_document is not None:
            _body_params = json_api_export_definition_post_optional_id_document
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/entities/workspaces/{workspaceId}/exportDefinitions',
    ...
    def delete_entity_export_definitions(
        ...
        _param = self._delete_entity_export_definitions_serialize(
            workspace_id=workspace_id,
            object_id=object_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_entity_export_definitions_with_http_info(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_entity_export_definitions_without_preload_content(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        _request_timeout: Union[
    ...
    def _delete_entity_export_definitions_serialize(
        self,
        workspace_id,
        object_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/entities/workspaces/{workspaceId}/exportDefinitions/{objectId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_entities_export_definitions(
        ...
        _param = self._get_all_entities_export_definitions_serialize(
            workspace_id=workspace_id,
            origin=origin,
            filter=filter,
            include=include,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "JsonApiExportDefinitionOutList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_all_entities_export_definitions_with_http_info(
        self,
        workspace_id: StrictStr,
        origin: Optional[StrictStr] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonApiExportDefinitionOutList]:
        """Get all Export Definitions
    ...
    @validate_call
    def get_all_entities_export_definitions_without_preload_content(
        self,
        workspace_id: StrictStr,
        origin: Optional[StrictStr] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
    ...
    def _get_all_entities_export_definitions_serialize(
        self,
        workspace_id,
        origin,
        filter,
    ...
    def get_entity_export_definitions(
        ...
        _param = self._get_entity_export_definitions_serialize(
            workspace_id=workspace_id,
            object_id=object_id,
            filter=filter,
            include=include,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "JsonApiExportDefinitionOutDocument",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_entity_export_definitions_with_http_info(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
    ...
    @validate_call
    def get_entity_export_definitions_without_preload_content(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
    ...
    def _get_entity_export_definitions_serialize(
        self,
        workspace_id,
        object_id,
        filter,
    ...
    def patch_entity_export_definitions(
        ...
        :param object_id: (required)
        :type object_id: str
        :param json_api_export_definition_patch_document: (required)
        :type json_api_export_definition_patch_document: JsonApiExportDefinitionPatchDocument
        :param filter: Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').
        :type filter: str
        :param include: Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together.
        :type include: List[str]
        ...
        _param = self._patch_entity_export_definitions_serialize(
            workspace_id=workspace_id,
            object_id=object_id,
            json_api_export_definition_patch_document=json_api_export_definition_patch_document,
            filter=filter,
            include=include,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_entity_export_definitions_with_http_info(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        json_api_export_definition_patch_document: JsonApiExportDefinitionPatchDocument,
    ...
    @validate_call
    def patch_entity_export_definitions_without_preload_content(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        json_api_export_definition_patch_document: JsonApiExportDefinitionPatchDocument,
    ...
    def _patch_entity_export_definitions_serialize(
        self,
        workspace_id,
        object_id,
        ...
        # process the form parameters
        # process the body parameter
        if json_api_export_definition_patch_document is not None:
            _body_params = json_api_export_definition_patch_document
    ...
    def search_entities_export_definitions(
        ...
        _param = self._search_entities_export_definitions_serialize(
            workspace_id=workspace_id,
    ...
    @validate_call
    def search_entities_export_definitions_with_http_info(
        self,
        workspace_id: StrictStr,
        entity_search_body: Annotated[EntitySearchBody, Field(description="Search request body with filter, pagination, and sorting options")],
        origin: Optional[StrictStr] = None,
    ...
    @validate_call
    def search_entities_export_definitions_without_preload_content(
        self,
        workspace_id: StrictStr,
        entity_search_body: Annotated[EntitySearchBody, Field(description="Search request body with filter, pagination, and sorting options")],
        origin: Optional[StrictStr] = None,
    ...
    def _search_entities_export_definitions_serialize(
        self,
        workspace_id,
        entity_search_body,
        origin,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/entities/workspaces/{workspaceId}/exportDefinitions/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_entity_export_definitions(
        ...
        :param object_id: (required)
        :type object_id: str
        :param json_api_export_definition_in_document: (required)
        :type json_api_export_definition_in_document: JsonApiExportDefinitionInDocument
        :param filter: Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').
        :type filter: str
        :param include: Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together.
        :type include: List[str]
        ...
        _param = self._update_entity_export_definitions_serialize(
            workspace_id=workspace_id,
            object_id=object_id,
            json_api_export_definition_in_document=json_api_export_definition_in_document,
            filter=filter,
            include=include,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_entity_export_definitions_with_http_info(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        json_api_export_definition_in_document: JsonApiExportDefinitionInDocument,
    ...
    @validate_call
    def update_entity_export_definitions_without_preload_content(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        json_api_export_definition_in_document: JsonApiExportDefinitionInDocument,
    ...
    def _update_entity_export_definitions_serialize(
        self,
        workspace_id,
        object_id,
        ...
        # process the form parameters
        # process the body parameter
        if json_api_export_definition_in_document is not None:
            _body_params = json_api_export_definition_in_document
