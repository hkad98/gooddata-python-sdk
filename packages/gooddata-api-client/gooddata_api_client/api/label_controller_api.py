...
class LabelControllerApi:
    ...
    def get_all_entities_labels(
        ...
        _param = self._get_all_entities_labels_serialize(
    ...
    @validate_call
    def get_all_entities_labels_with_http_info(
        self,
        workspace_id: StrictStr,
        origin: Optional[StrictStr] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonApiLabelOutList]:
        """Get all Labels
    ...
    @validate_call
    def get_all_entities_labels_without_preload_content(
        self,
        workspace_id: StrictStr,
        origin: Optional[StrictStr] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
    ...
    def _get_all_entities_labels_serialize(
        self,
        workspace_id,
        origin,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/entities/workspaces/{workspaceId}/labels',
    ...
    def get_entity_labels(
        ...
        _param = self._get_entity_labels_serialize(
            workspace_id=workspace_id,
            object_id=object_id,
            filter=filter,
            include=include,
    ...
    @validate_call
    def get_entity_labels_with_http_info(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonApiLabelOutDocument]:
        """Get a Label
    ...
    @validate_call
    def get_entity_labels_without_preload_content(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        filter: Annotated[Optional[StrictStr], Field(description="Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').")] = None,
    ...
    def _get_entity_labels_serialize(
        self,
        workspace_id,
        object_id,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/entities/workspaces/{workspaceId}/labels/{objectId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_entity_labels(
        ...
        :param object_id: (required)
        :type object_id: str
        :param json_api_label_patch_document: (required)
        :type json_api_label_patch_document: JsonApiLabelPatchDocument
        :param filter: Filtering parameter in RSQL. See https://github.com/jirutka/rsql-parser. You can specify any object parameter and parameter of related entity (for example title=='Some Title';description=='desc'). Additionally, if the entity relationship represents a polymorphic entity type, it can be casted to its subtypes (for example relatedEntity::subtype.subtypeProperty=='Value 123').
        :type filter: str
        :param include: Array of included collections or individual relationships. Includes are separated by commas (e.g. include=entity1s,entity2s). Collection include represents the inclusion of every relationship between this entity and the given collection. Relationship include represents the inclusion of the particular relationships only. If single parameter \"ALL\" is present, all possible includes are used (include=ALL).  __WARNING:__ Individual include types (collection, relationship or ALL) cannot be combined together.
        :type include: List[str]
        ...
        _param = self._patch_entity_labels_serialize(
            workspace_id=workspace_id,
            object_id=object_id,
            json_api_label_patch_document=json_api_label_patch_document,
            filter=filter,
            include=include,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_entity_labels_with_http_info(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        json_api_label_patch_document: JsonApiLabelPatchDocument,
    ...
    @validate_call
    def patch_entity_labels_without_preload_content(
        self,
        workspace_id: StrictStr,
        object_id: StrictStr,
        json_api_label_patch_document: JsonApiLabelPatchDocument,
    ...
    def _patch_entity_labels_serialize(
        self,
        workspace_id,
        object_id,
        ...
        # process the form parameters
        # process the body parameter
        if json_api_label_patch_document is not None:
            _body_params = json_api_label_patch_document
    ...
    def search_entities_labels(
        ...
        _param = self._search_entities_labels_serialize(
            workspace_id=workspace_id,
    ...
    @validate_call
    def search_entities_labels_with_http_info(
        self,
        workspace_id: StrictStr,
        entity_search_body: Annotated[EntitySearchBody, Field(description="Search request body with filter, pagination, and sorting options")],
        origin: Optional[StrictStr] = None,
    ...
    @validate_call
    def search_entities_labels_without_preload_content(
        self,
        workspace_id: StrictStr,
        entity_search_body: Annotated[EntitySearchBody, Field(description="Search request body with filter, pagination, and sorting options")],
        origin: Optional[StrictStr] = None,
    ...
    def _search_entities_labels_serialize(
        self,
        workspace_id,
        entity_search_body,
        origin,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/entities/workspaces/{workspaceId}/labels/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
