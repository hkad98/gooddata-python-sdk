...
class TabularExportApi:
    ...
    def create_dashboard_export_request(
        ...
        :param dashboard_tabular_export_request: (required)
        :type dashboard_tabular_export_request: DashboardTabularExportRequest
        ...
        _param = self._create_dashboard_export_request_serialize(
            workspace_id=workspace_id,
            dashboard_id=dashboard_id,
            dashboard_tabular_export_request=dashboard_tabular_export_request,
    ...
    @validate_call
    def create_dashboard_export_request_with_http_info(
        self,
        workspace_id: StrictStr,
        dashboard_id: StrictStr,
        dashboard_tabular_export_request: DashboardTabularExportRequest,
    ...
    @validate_call
    def create_dashboard_export_request_without_preload_content(
        self,
        workspace_id: StrictStr,
        dashboard_id: StrictStr,
        dashboard_tabular_export_request: DashboardTabularExportRequest,
    ...
    def _create_dashboard_export_request_serialize(
        self,
        workspace_id,
        dashboard_id,
        ...
        if dashboard_tabular_export_request is not None:
            _body_params = dashboard_tabular_export_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/workspaces/{workspaceId}/analyticalDashboards/{dashboardId}/export/tabular',
    ...
    def create_tabular_export(
        ...
        :param workspace_id: (required)
        :type workspace_id: str
        :param tabular_export_request: (required)
        :type tabular_export_request: TabularExportRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_tabular_export_serialize(
            workspace_id=workspace_id,
            tabular_export_request=tabular_export_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def create_tabular_export_with_http_info(
        self,
        workspace_id: StrictStr,
        tabular_export_request: TabularExportRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def create_tabular_export_without_preload_content(
        self,
        workspace_id: StrictStr,
        tabular_export_request: TabularExportRequest,
        _request_timeout: Union[
    ...
    def _create_tabular_export_serialize(
        self,
        workspace_id,
        ...
        # process the form parameters
        # process the body parameter
        if tabular_export_request is not None:
            _body_params = tabular_export_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/workspaces/{workspaceId}/export/tabular',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_tabular_export(
        ...
        _param = self._get_tabular_export_serialize(
            workspace_id=workspace_id,
            export_id=export_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_tabular_export_with_http_info(
        self,
        workspace_id: StrictStr,
        export_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def get_tabular_export_without_preload_content(
        self,
        workspace_id: StrictStr,
        export_id: StrictStr,
        _request_timeout: Union[
    ...
    def _get_tabular_export_serialize(
        self,
        workspace_id,
        export_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/actions/workspaces/{workspaceId}/export/tabular/{exportId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
