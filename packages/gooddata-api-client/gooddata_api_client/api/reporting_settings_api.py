...
class ReportingSettingsApi:
    ...
    def resolve_all_settings_without_workspace(
        ...
        _param = self._resolve_all_settings_without_workspace_serialize(
    ...
    @validate_call
    def resolve_all_settings_without_workspace_with_http_info(
        self,
        exclude_user_settings: Annotated[Optional[StrictBool], Field(description="If true, user-level settings are excluded from resolution.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def resolve_all_settings_without_workspace_without_preload_content(
        self,
        exclude_user_settings: Annotated[Optional[StrictBool], Field(description="If true, user-level settings are excluded from resolution.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _resolve_all_settings_without_workspace_serialize(
        self,
    ...
    def resolve_settings_without_workspace(
        ...
        _param = self._resolve_settings_without_workspace_serialize(
    ...
    @validate_call
    def resolve_settings_without_workspace_with_http_info(
        self,
        resolve_settings_request: ResolveSettingsRequest,
        exclude_user_settings: Annotated[Optional[StrictBool], Field(description="If true, user-level settings are excluded from resolution.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def resolve_settings_without_workspace_without_preload_content(
        self,
        resolve_settings_request: ResolveSettingsRequest,
        exclude_user_settings: Annotated[Optional[StrictBool], Field(description="If true, user-level settings are excluded from resolution.")] = None,
        _request_timeout: Union[
    ...
    def _resolve_settings_without_workspace_serialize(
        self,
