...
class DataSourceStagingLocationApi:
    ...
    def staging_upload(
        ...
        _param = self._staging_upload_serialize(
            file=file,
    ...
    @validate_call
    def staging_upload_with_http_info(
        self,
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="The file to upload.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def staging_upload_without_preload_content(
        self,
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="The file to upload.")],
        _request_timeout: Union[
            None,
    ...
    def _staging_upload_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/actions/fileStorage/staging/upload',
