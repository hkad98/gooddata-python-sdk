...
class LlmModel(BaseModel):
    ...
    def family_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['OPENAI', 'ANTHROPIC', 'META', 'MISTRAL', 'AMAZON', 'GOOGLE', 'COHERE', 'UNKNOWN']):
            raise ValueError("must be one of enum values ('OPENAI', 'ANTHROPIC', 'META', 'MISTRAL', 'AMAZON', 'GOOGLE', 'COHERE', 'UNKNOWN')")
        return value
