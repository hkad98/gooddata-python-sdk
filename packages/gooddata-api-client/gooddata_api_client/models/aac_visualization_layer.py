...
class AacVisualizationLayer(BaseModel):
    ...
    metrics: Optional[List[Optional[AacVisualizationGeoBucketsAllOfViewBy]]] = Field(default=None, description="Layer metrics.")
    segment_by: Optional[List[Optional[AacVisualizationGeoBucketsAllOfViewBy]]] = Field(default=None, description="Layer segment by.")
    ...
    view_by: Optional[List[Optional[AacVisualizationGeoBucketsAllOfViewBy]]] = Field(default=None, description="Layer view by.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "metrics": [AacVisualizationGeoBucketsAllOfViewBy.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
            "segment_by": [AacVisualizationGeoBucketsAllOfViewBy.from_dict(_item) for _item in obj["segment_by"]] if obj.get("segment_by") is not None else None,
            "sorts": obj.get("sorts"),
            "title": obj.get("title"),
            "type": obj.get("type"),
