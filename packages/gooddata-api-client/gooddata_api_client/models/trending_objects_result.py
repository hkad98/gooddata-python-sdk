...
class TrendingObjectsResult(BaseModel):
    """
    TrendingObjectsResult
    """ # noqa: E501
    objects: List[TrendingObjectItem]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objects": [TrendingObjectItem.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None
        })
