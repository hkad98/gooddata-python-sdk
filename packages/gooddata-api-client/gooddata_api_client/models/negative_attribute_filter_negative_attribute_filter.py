...
class NegativeAttributeFilterNegativeAttributeFilter(BaseModel):
    ...
    uses_arbitrary_values: Optional[StrictBool] = Field(default=None, description="If true, indicates that the values in notInElements were filled free-form, otherwise they have been picked from existing elements.", alias="usesArbitraryValues")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["applyOnResult", "label", "localIdentifier", "notIn", "usesArbitraryValues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usesArbitraryValues": obj.get("usesArbitraryValues")
        })
