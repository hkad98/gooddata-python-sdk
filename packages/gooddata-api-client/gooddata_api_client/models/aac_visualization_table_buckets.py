...
class AacVisualizationTableBuckets(BaseModel):
    ...
    attributes: Optional[List[Optional[AacVisualizationTableBucketsAllOfAttributes]]] = Field(default=None, description="Attributes bucket (for scatter).")
    columns: Optional[List[Optional[AacVisualizationTableBucketsAllOfColumns]]] = Field(default=None, description="Columns bucket (for tables).")
    ...
    metrics: Optional[List[Optional[AacVisualizationTableBucketsAllOfMetrics]]] = Field(default=None, description="Metrics bucket.")
    query: AacQuery
    rows: Optional[List[Optional[AacVisualizationTableBucketsAllOfRows]]] = Field(default=None, description="Rows bucket (for tables).")
    segment_by: Optional[List[Optional[AacVisualizationTableBucketsAllOfSegmentBy]]] = Field(default=None, description="Segment by attributes bucket.")
    show_in_ai_results: Optional[StrictBool] = Field(default=None, description="Whether to show in AI results.")
    size_by: Optional[List[Optional[AacVisualizationTableBucketsAllOfSizeBy]]] = Field(default=None, description="Size by metrics bucket.")
    stack_by: Optional[List[Optional[AacVisualizationTableBucketsAllOfStackBy]]] = Field(default=None, description="Stack by attributes bucket.")
    ...
    trend_by: Optional[List[Optional[AacVisualizationTableBucketsAllOfTrendBy]]] = Field(default=None, description="Trend by attributes bucket.")
    type: StrictStr
    view_by: Optional[List[Optional[AacVisualizationTableBucketsAllOfViewBy]]] = Field(default=None, description="View by attributes bucket.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['table', 'heatmap_chart', 'repeater_chart']):
            raise ValueError("must be one of enum values ('table', 'heatmap_chart', 'repeater_chart')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": [AacVisualizationTableBucketsAllOfAttributes.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None,
            "columns": [AacVisualizationTableBucketsAllOfColumns.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None,
            ...
            "metrics": [AacVisualizationTableBucketsAllOfMetrics.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
            "query": AacQuery.from_dict(obj["query"]) if obj.get("query") is not None else None,
            "rows": [AacVisualizationTableBucketsAllOfRows.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None,
            "segment_by": [AacVisualizationTableBucketsAllOfSegmentBy.from_dict(_item) for _item in obj["segment_by"]] if obj.get("segment_by") is not None else None,
            "show_in_ai_results": obj.get("show_in_ai_results"),
            "size_by": [AacVisualizationTableBucketsAllOfSizeBy.from_dict(_item) for _item in obj["size_by"]] if obj.get("size_by") is not None else None,
            "stack_by": [AacVisualizationTableBucketsAllOfStackBy.from_dict(_item) for _item in obj["stack_by"]] if obj.get("stack_by") is not None else None,
            "tags": obj.get("tags"),
            "title": obj.get("title"),
            "to": obj.get("to"),
            "trend_by": [AacVisualizationTableBucketsAllOfTrendBy.from_dict(_item) for _item in obj["trend_by"]] if obj.get("trend_by") is not None else None,
            "type": obj.get("type"),
            "view_by": [AacVisualizationTableBucketsAllOfViewBy.from_dict(_item) for _item in obj["view_by"]] if obj.get("view_by") is not None else None
        })
