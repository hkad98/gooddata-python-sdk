...
class AacDashboardWithoutTabs(BaseModel):
    ...
    plugins: Optional[List[AacDashboardWithoutTabsAllOfPlugins]] = Field(default=None, description="Dashboard plugins.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plugins": [AacDashboardWithoutTabsAllOfPlugins.from_dict(_item) for _item in obj["plugins"]] if obj.get("plugins") is not None else None,
