...
class PositiveAttributeFilterPositiveAttributeFilter(BaseModel):
    ...
    uses_arbitrary_values: Optional[StrictBool] = Field(default=None, description="If true, indicates that the values in inElements were filled free-form, otherwise they have been picked from existing elements.", alias="usesArbitraryValues")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["applyOnResult", "in", "label", "localIdentifier", "usesArbitraryValues"]
