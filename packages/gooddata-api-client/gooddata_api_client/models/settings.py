...
class Settings(BaseModel):
    ...
    grand_totals_position: Optional[StrictStr] = Field(default=None, description="Grand totals position. Takes precedence over position specified in visualization.", alias="grandTotalsPosition")
    ...
    __properties: ClassVar[List[str]] = ["delimiter", "exportInfo", "grandTotalsPosition", "mergeHeaders", "pageOrientation", "pageSize", "pdfPageSize", "pdfTableStyle", "pdfTopLeftContent", "pdfTopRightContent", "showFilters"]
    ...
    @field_validator('grand_totals_position')
    def grand_totals_position_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['pinnedBottom', 'pinnedTop', 'bottom', 'top']):
            raise ValueError("must be one of enum values ('pinnedBottom', 'pinnedTop', 'bottom', 'top')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "grandTotalsPosition": obj.get("grandTotalsPosition"),
