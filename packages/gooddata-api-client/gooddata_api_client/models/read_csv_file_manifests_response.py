...
class ReadCsvFileManifestsResponse(BaseModel):
    """
    Describes the results of a CSV manifest read of a single file.
    """ # noqa: E501
    manifest: CsvManifestBody
    name: StrictStr = Field(description="Name of the file in the source data source.")
    version: StrictInt = Field(description="Version of the file in the source data source.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["manifest", "name", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "manifest": CsvManifestBody.from_dict(obj["manifest"]) if obj.get("manifest") is not None else None,
            "name": obj.get("name"),
