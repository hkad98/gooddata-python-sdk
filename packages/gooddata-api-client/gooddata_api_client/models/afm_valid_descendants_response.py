...
class AfmValidDescendantsResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "validDescendants": {
                _k: [AfmObjectIdentifierAttribute.from_dict(_item) for _item in _v] if _v is not None else None
                for _k, _v in obj["validDescendants"].items()
            }
            if obj.get("validDescendants") is not None
            else None
        })
