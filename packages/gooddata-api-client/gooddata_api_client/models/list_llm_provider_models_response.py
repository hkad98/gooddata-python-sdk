...
class ListLlmProviderModelsResponse(BaseModel):
    """
    ListLlmProviderModelsResponse
    """ # noqa: E501
    message: StrictStr = Field(description="Message about the listing result.")
    models: List[LlmModel] = Field(description="Available models on the provider.")
    success: StrictBool = Field(description="Whether the model listing succeeded.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["message", "models", "success"]
