...
class AzureFoundryProviderConfig(BaseModel):
    ...
    endpoint: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Azure OpenAI endpoint URL.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['AZURE_FOUNDRY']):
            raise ValueError("must be one of enum values ('AZURE_FOUNDRY')")
        return value
