...
import json
import pprint
from pydantic import BaseModel, ConfigDict, Field, StrictBool, StrictStr, ValidationError, field_validator, model_serializer
from typing import Any, List, Optional
from pydantic import StrictStr, Field
from typing import Union, List, Set, Optional, Dict
from typing_extensions import Literal, Self

AACVISUALIZATIONSWITCHERWIDGETALLOFDESCRIPTION_ONE_OF_SCHEMAS = ["bool", "str"]

class AacVisualizationSwitcherWidgetAllOfDescription(BaseModel):
    """
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = AacVisualizationSwitcherWidgetAllOfDescription.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in AacVisualizationSwitcherWidgetAllOfDescription with oneOf schemas: bool, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in AacVisualizationSwitcherWidgetAllOfDescription with oneOf schemas: bool, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        for variant in variant_classes:
            try:
                ...
                continue
        raise ValueError(
            "No match found when deserializing the JSON string into AacVisualizationSwitcherWidgetAllOfDescription"
            " with oneOf schemas: bool, str"
        )
