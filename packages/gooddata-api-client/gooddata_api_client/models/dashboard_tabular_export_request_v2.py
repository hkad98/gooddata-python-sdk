    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dashboardTabsFiltersOverrides": {
                _k: [DashboardFilter.from_dict(_item) for _item in _v] if _v is not None else None
                for _k, _v in obj["dashboardTabsFiltersOverrides"].items()
            }
            if obj.get("dashboardTabsFiltersOverrides") is not None
            else None,
