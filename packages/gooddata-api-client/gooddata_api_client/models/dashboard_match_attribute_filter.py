...
class DashboardMatchAttributeFilter(BaseModel):
    """
    DashboardMatchAttributeFilter
    """ # noqa: E501
    match_attribute_filter: DashboardMatchAttributeFilterMatchAttributeFilter = Field(alias="matchAttributeFilter")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "matchAttributeFilter": DashboardMatchAttributeFilterMatchAttributeFilter.from_dict(obj["matchAttributeFilter"]) if obj.get("matchAttributeFilter") is not None else None
        })
