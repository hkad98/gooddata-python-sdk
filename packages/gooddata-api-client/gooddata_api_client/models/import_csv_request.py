...
class ImportCsvRequest(BaseModel):
    ...
    """ # noqa: E501
    tables: List[ImportCsvRequestTable] = Field(description="Information about the individual tables.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tables": [ImportCsvRequestTable.from_dict(_item) for _item in obj["tables"]] if obj.get("tables") is not None else None
        })
