...
class ImportCsvRequestTableSource(BaseModel):
    """
    Information about source data for a particular table.
    """ # noqa: E501
    config: ImportCsvRequestTableSourceConfig
    location: StrictStr = Field(description="Location of the data in the staging area.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": ImportCsvRequestTableSourceConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
