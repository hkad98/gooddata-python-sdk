    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        for variant in variant_classes:
            try:
                ...
                continue
        raise ValueError(
            "No match found when deserializing the JSON string into ManageDashboardPermissionsRequestInner"
            " with oneOf schemas: PermissionsForAssignee, PermissionsForAssigneeRule"
        )
