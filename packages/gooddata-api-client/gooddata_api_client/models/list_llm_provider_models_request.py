...
class ListLlmProviderModelsRequest(BaseModel):
    """
    ListLlmProviderModelsRequest
    """ # noqa: E501
    provider_config: ListLlmProviderModelsRequestProviderConfig = Field(alias="providerConfig")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["providerConfig"]
