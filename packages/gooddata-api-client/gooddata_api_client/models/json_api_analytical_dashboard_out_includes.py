...
class JsonApiAnalyticalDashboardOutIncludes(BaseModel):
    ...
    oneof_schema_2_validator: Optional[JsonApiDashboardPluginOutWithLinks] = None
    # data type: JsonApiDatasetOutWithLinks
    oneof_schema_3_validator: Optional[JsonApiDatasetOutWithLinks] = None
    # data type: JsonApiFilterContextOutWithLinks
    oneof_schema_4_validator: Optional[JsonApiFilterContextOutWithLinks] = None
    ...
    oneof_schema_7_validator: Optional[JsonApiUserIdentifierOutWithLinks] = None
    # data type: JsonApiVisualizationObjectOutWithLinks
    oneof_schema_8_validator: Optional[JsonApiVisualizationObjectOutWithLinks] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        for variant in variant_classes:
            try:
                ...
                continue
        raise ValueError(
            "No match found when deserializing the JSON string into JsonApiAnalyticalDashboardOutIncludes"
            " with oneOf schemas: JsonApiAnalyticalDashboardOutWithLinks, JsonApiDashboardPluginOutWithLinks, JsonApiDatasetOutWithLinks, JsonApiFilterContextOutWithLinks, JsonApiLabelOutWithLinks, JsonApiMetricOutWithLinks, JsonApiUserIdentifierOutWithLinks, JsonApiVisualizationObjectOutWithLinks"
        )
