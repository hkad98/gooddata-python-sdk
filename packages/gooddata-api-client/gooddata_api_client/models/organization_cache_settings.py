...
class OrganizationCacheSettings(BaseModel):
    ...
    """ # noqa: E501
    extra_cache_budget: StrictInt = Field(description="Extra cache budget the organization can allocate among its workspaces, in bytes.", alias="extraCacheBudget")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["extraCacheBudget"]
