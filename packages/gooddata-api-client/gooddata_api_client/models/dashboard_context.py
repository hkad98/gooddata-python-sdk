...
class DashboardContext(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Dashboard object ID.")
    widgets: List[WidgetDescriptor] = Field(description="Widgets currently visible on the dashboard.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "widgets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "widgets": [WidgetDescriptor.from_dict(_item) for _item in obj["widgets"]] if obj.get("widgets") is not None else None
        })
