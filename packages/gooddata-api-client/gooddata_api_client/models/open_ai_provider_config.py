...
class OpenAIProviderConfig(BaseModel):
    ...
    base_url: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default='https://api.openai.com/v1', description="Custom base URL for OpenAI API.", alias="baseUrl")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "baseUrl": obj.get("baseUrl") if obj.get("baseUrl") is not None else 'https://api.openai.com/v1',
