...
class AacRichTextWidget(BaseModel):
    ...
    description: Optional[AacRichTextWidgetAllOfDescription] = None
    ...
    title: Optional[AacRichTextWidgetAllOfTitle] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "date": obj.get("date"),
            "description": AacRichTextWidgetAllOfDescription.from_dict(obj["description"]) if obj.get("description") is not None else None,
            ...
            "title": AacRichTextWidgetAllOfTitle.from_dict(obj["title"]) if obj.get("title") is not None else None,
            "type": obj.get("type"),
