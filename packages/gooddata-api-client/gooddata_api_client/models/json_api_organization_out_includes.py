...
class JsonApiOrganizationOutIncludes(BaseModel):
    ...
    oneof_schema_1_validator: Optional[JsonApiIdentityProviderOutWithLinks] = None
    ...
    oneof_schema_3_validator: Optional[JsonApiUserGroupOutWithLinks] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        for variant in variant_classes:
            try:
                ...
                continue
        raise ValueError(
            "No match found when deserializing the JSON string into JsonApiOrganizationOutIncludes"
            " with oneOf schemas: JsonApiIdentityProviderOutWithLinks, JsonApiUserGroupOutWithLinks, JsonApiUserOutWithLinks"
        )
