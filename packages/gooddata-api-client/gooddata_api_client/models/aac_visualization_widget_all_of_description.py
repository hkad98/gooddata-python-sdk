...
AACVISUALIZATIONWIDGETALLOFDESCRIPTION_ONE_OF_SCHEMAS = ["bool", "str"]

class AacVisualizationWidgetAllOfDescription(BaseModel):
    """
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = AacVisualizationWidgetAllOfDescription.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in AacVisualizationWidgetAllOfDescription with oneOf schemas: bool, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in AacVisualizationWidgetAllOfDescription with oneOf schemas: bool, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        for variant in variant_classes:
            try:
                ...
                continue
        raise ValueError(
            "No match found when deserializing the JSON string into AacVisualizationWidgetAllOfDescription"
