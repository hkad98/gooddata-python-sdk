...
class WidgetDescriptor(BaseModel):
    ...
    """ # noqa: E501
    filters: Optional[List[ChangeAnalysisParamsFiltersInner]] = None
    title: StrictStr
    widget_id: StrictStr = Field(alias="widgetId")
    widget_type: StrictStr = Field(alias="widgetType")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["filters", "title", "widgetId", "widgetType"]
