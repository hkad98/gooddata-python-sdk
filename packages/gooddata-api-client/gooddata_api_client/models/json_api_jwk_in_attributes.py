...
class JsonApiJwkInAttributes(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[RsaSpecification] = Field(default=None, description="Specification of the cryptographic key")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": RsaSpecification.from_dict(obj["content"]) if obj.get("content") is not None else None
        })
