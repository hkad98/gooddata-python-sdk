...
class DashboardMatchAttributeFilterMatchAttributeFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["caseSensitive", "displayForm", "literal", "localIdentifier", "negativeSelection", "operator", "title"]

    @field_validator('operator')
    def operator_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['contains', 'startsWith', 'endsWith']):
            raise ValueError("must be one of enum values ('contains', 'startsWith', 'endsWith')")
        return value
