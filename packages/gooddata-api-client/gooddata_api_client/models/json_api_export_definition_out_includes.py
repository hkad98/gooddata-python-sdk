...
class JsonApiExportDefinitionOutIncludes(BaseModel):
    ...
    oneof_schema_2_validator: Optional[JsonApiAutomationOutWithLinks] = None
    ...
    oneof_schema_4_validator: Optional[JsonApiVisualizationObjectOutWithLinks] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        for variant in variant_classes:
            try:
                ...
                continue
        raise ValueError(
            "No match found when deserializing the JSON string into JsonApiExportDefinitionOutIncludes"
            " with oneOf schemas: JsonApiAnalyticalDashboardOutWithLinks, JsonApiAutomationOutWithLinks, JsonApiUserIdentifierOutWithLinks, JsonApiVisualizationObjectOutWithLinks"
        )
