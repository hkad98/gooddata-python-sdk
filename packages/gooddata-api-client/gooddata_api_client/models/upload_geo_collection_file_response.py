...
class UploadGeoCollectionFileResponse(BaseModel):
    """
    Information related to the geo collection file uploaded to the staging area.
    """ # noqa: E501
    location: StrictStr = Field(description="Location to use when referencing the uploaded file in subsequent requests.")
