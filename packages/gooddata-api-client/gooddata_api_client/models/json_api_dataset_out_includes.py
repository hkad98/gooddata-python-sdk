...
class JsonApiDatasetOutIncludes(BaseModel):
    ...
    oneof_schema_1_validator: Optional[JsonApiAggregatedFactOutWithLinks] = None
    ...
    oneof_schema_4_validator: Optional[JsonApiFactOutWithLinks] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        for variant in variant_classes:
            try:
                ...
                continue
        raise ValueError(
            "No match found when deserializing the JSON string into JsonApiDatasetOutIncludes"
            " with oneOf schemas: JsonApiAggregatedFactOutWithLinks, JsonApiAttributeOutWithLinks, JsonApiDatasetOutWithLinks, JsonApiFactOutWithLinks, JsonApiWorkspaceDataFilterOutWithLinks"
        )
