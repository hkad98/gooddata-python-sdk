...
class ResolvedLlmProvider(BaseModel):
    ...
    ResolvedLlmProvider
    """ # noqa: E501
    id: StrictStr = Field(description="Provider Id")
    title: StrictStr = Field(description="Provider Title")
    models: Annotated[List[LlmModel], Field(min_length=1, max_length=1)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "title", "models"]
